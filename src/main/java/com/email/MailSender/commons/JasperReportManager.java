package com.email.MailSender.commons;
...
public class JasperReportManager {
	...
	public ByteArrayOutputStream export(String fileName, String tipoReporte, Map<String, Object> params, Connection con) throws JRException, IOException {
		...
		InputStream inputStram = resource.getInputStream();
		JasperPrint jasperPrint = JasperFillManager.fillReport(inputStram, params, con);
